...
class ActivityLogsModule {
    constructor() {
        ...
        this.isPicto = path.includes('PICTO');
        this.isLupto = path.includes('LUPTO');
        this.isMunicipal = path.includes('MUNICIPAL');
    ...
    async init() {
        ...
        try {
            ...
            debugDiv.textContent = 'INIT ERROR: ' + (err.stack || err.message || err);
