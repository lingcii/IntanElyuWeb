...
(function () {
    if (window.__LB_PICTO_LOADED__) return;
    window.__LB_PICTO_LOADED__ = true;
    ...
    const LB_API = window.API_CONFIG?.PICTO + '/leaderboard' || 'http://localhost:8000/api/pitco/leaderboard';
    ...
    window.__LB_PICTO_CACHE__ = window.__LB_PICTO_CACHE__ || { data: null, timestamp: 0, kpis: null };
    ...
    function isCacheFresh() {
        const cache = window.__LB_PICTO_CACHE__;
