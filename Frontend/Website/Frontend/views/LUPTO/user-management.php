...
ob_start();
?>
<link rel="stylesheet" href="../../css/LUPTO/user-management.css">
<?php
...
<div class="um-page-header">
    ...
    <div class="um-header-actions">
        ...
        <button class="btn-gov" onclick="openAddModal()">
            <i class="fas fa-user-plus"></i> Add Municipal User
        </button>
    </div>
</div>
...
<div class="um-kpi-strip" id="kpiStrip">
    ...
    <div class="um-kpi-card">
        <div class="um-kpi-icon purple"><i class="fas fa-user-plus"></i></div>
        ...
        <div class="um-modal-body">
            <form id="userForm" novalidate>
                ...
                <div class="um-form-grid">
                    ...
                    <!-- Role (locked to Municipal for add, read-only for edit) -->
                    <div class="um-form-group">
                        <label class="um-form-label" for="formRoleDisplay">Role <span class="required">*</span></label>
                        <input type="text" id="formRoleDisplay" class="um-form-control" readonly style="background: #f8fafc; color: #64748b; font-weight: 600; cursor: not-allowed;" value="MUNICIPAL">
                        <input type="hidden" id="formRole" value="municipal">
                    </div>
    ...
    <div class="um-modal sm">
        ...
        <div class="um-modal-footer" style="justify-content:center; gap:12px;">
            ...
            <button class="btn-gov" id="umSaveConfirmBtn" onclick="confirmSaveUser()" style="min-width:130px;">
                ...
                <span id="umSaveConfirmLabel">Yes, Save</span>
            </button>
        </div>
    </div>
</div>
...
<script src="../../scripts/functions/LUPTO/user-management-api.js?v=<?= time() ?>"></script>
