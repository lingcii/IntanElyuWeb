    ...
    <div class="detail-drawer" id="detail-drawer">
        ...
        <div class="detail-drawer-body">
            ...
            <div class="drawer-section">
                ...
                <div class="drawer-info-grid">
                    ...
                    <div class="drawer-info-item">
                        <span class="drawer-info-label">Module</span>
                        <span class="drawer-info-value" id="drawer-module">-</span>
                    </div>
                    <div class="drawer-info-item full-width">
                        <span class="drawer-info-label">Description</span>
                        <span class="drawer-info-value" id="drawer-description">-</span>
                    </div>
                </div>
            </div>
            ...
            <div class="drawer-section">
                ...
                <div class="drawer-info-grid">
                    <div class="drawer-info-item">
                        <span class="drawer-info-label">IP Address</span>
                        <span class="drawer-info-value" id="drawer-ip">-</span>
                    </div>
                    <div class="drawer-info-item">
                        <span class="drawer-info-label">Timestamp</span>
                        <span class="drawer-info-value" id="drawer-timestamp">-</span>
                        <span style="font-size:11px; color:var(--text-muted)" id="drawer-relative-time">-</span>
                    </div>
                    <div class="drawer-info-item">
                        <span class="drawer-info-label">Device</span>
                        <span class="drawer-info-value" id="drawer-device">-</span>
                    </div>
                    <div class="drawer-info-item">
                        <span class="drawer-info-label">Browser</span>
                        <span class="drawer-info-value" id="drawer-browser">-</span>
                    </div>
                    <div class="drawer-info-item">
                        <span class="drawer-info-label">Operating System</span>
                        <span class="drawer-info-value" id="drawer-os">-</span>
                    </div>
                    <div class="drawer-info-item full-width">
                        <span class="drawer-info-label">User Agent</span>
                        <span class="drawer-info-value" id="drawer-user-agent" style="font-size:11px; word-break: break-all;">-</span>
                    </div>
                </div>
            </div>
            ...
            <div class="drawer-section">
                ...
                <div>
                    ...
                    <pre class="diff-viewer" id="drawer-new-val" style="margin-top:8px;">None</pre>
                </div>
            </div>
        </div>
    </div>
