                ...
                <form id="spotForm">
                    ...
                    <div class="sfm-section">
                        ...
                        <div class="sfm-location-row">
                            <div class="sfm-location-barangay">
                                ...
                                <select id="spotBarangay" class="sfm-select" onchange="var b=this.value,m=window.municipalityData&&window.municipalityData.name;if(b&&m&&window.autoPinBarangay)window.autoPinBarangay(b,m)">
                    ...
                    <div class="sfm-section">
                        ...
                        <div style="display: flex; gap: 16px;">
                            ...
                            <div class="sfm-field" style="flex: 1; margin-bottom: 0; display: none;">
                                <label class="sfm-label" for="spotPoints">
                                     Points <span class="sfm-required">*</span>
                                 </label>
                                 <input type="number" id="spotPoints" class="sfm-input" value="0">
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal" id="saveConfirmModal" style="z-index: 10002;">
        <div class="modal-content" style="max-width: 420px; border-radius: 16px; overflow: hidden;">
            <div style="background: #DBEAFE; padding: 28px 28px 16px 28px; text-align: center;">
                ...
                <h3 style="margin: 0; font-size: 18px; font-weight: 700; color: #1E3A8A;">Confirm Save</h3>
            </div>
            <div style="padding: 20px 28px 28px 28px;">
                <p id="saveConfirmMessage" style="text-align: center; color: #4B5563; margin: 0 0 12px 0; font-size: 14px;">Are you sure you want to save these changes?</p>
                <p id="saveConfirmRejectedNote" style="display:none; text-align:center; background:#FEF3C7; border:1px solid #FDE68A; border-radius:8px; padding:10px 14px; margin: 0 0 20px 0; font-size:13px; color:#92400E; line-height:1.5;">
                    <i class="fas fa-info-circle"></i> This tourist spot was previously <strong>rejected</strong>. Upon saving, it will be submitted to LUPTO for review again.
                </p>
                <div style="display: flex; gap: 12px;" id="saveConfirmBtns">
                    <button class="btn btn-outline" id="saveConfirmNoBtn" data-action="close-save-confirm" style="flex: 1; justify-content: center;">
