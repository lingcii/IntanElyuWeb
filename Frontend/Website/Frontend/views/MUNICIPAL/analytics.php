...
// Check role
if (!in_array($_SESSION['user_role'], ['municipal', 'admin_mto', 'staff_mto'])) {
...
<div class="pa-kpi-grid">
    ...
    <div class="pa-kpi-card">
        ...
        <div class="pa-kpi-info">
            <h4>Total Spots</h4>
            <p id="kpiSpots">—</p>
            <small>Spots in <span id="kpiMuniScope">—</span></small>
        </div>
    </div>
...
<!-- Row 2: Top Categories + Monthly Estimated Revenue -->
<div class="pa-row-flex">
    <!-- Top Categories -->
    ...
    <!-- Monthly Estimated Revenue Chart -->
    <div class="pa-col-half card">
        <div class="card-header">
            <h3 class="pa-section-title"><i class="fas fa-wallet"></i> Monthly Tourism Revenue</h3>
        </div>
        <div class="pa-chart-body" style="height:300px; position:relative;">
            <canvas id="revenueChart" role="img" aria-label="Horizontal bar chart showing monthly estimated tourism revenue"></canvas>
        </div>
    </div>
</div>
