...
$isMunicipalRole = ($userRole === 'municipal' || str_ends_with($userRole, '_mto'));
...
$pageTitle = $muniName . ' MTO - Feedback Management';
...
<div class="feedback-container">
    ...
    <div class="feedback-kpi-grid">
        <div class="feedback-kpi-card">
            <div class="feedback-kpi-info">
                ...
                <span class="feedback-kpi-subtext"><i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($muniName) ?></span>
            </div>
        ...
        <div class="feedback-kpi-card">
            <div class="feedback-kpi-info">
                ...
                <span class="feedback-kpi-subtext"><i class="fas fa-comments"></i> Local Submissions</span>
            </div>
        ...
        <div class="feedback-kpi-card">
            <div class="feedback-kpi-info">
                ...
                <span class="feedback-kpi-subtext"><i class="fas fa-star" style="color:#f59e0b;"></i> Municipal Avg</span>
            </div>
    ...
    <div class="feedback-toolbar">
        <div class="toolbar-search">
            ...
            <input type="text" id="feedback-search-input" placeholder="Search spot name, user, comment...">
        </div>
        <div class="toolbar-filters">
            <!-- Hidden filter for municipality (scoped via backend session) -->
