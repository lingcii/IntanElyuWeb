...
$extraHeadContent = '
    <link rel="stylesheet" href="../../css/MUNICIPAL/settings.css">
    <script src="../../scripts/functions/MUNICIPAL/settings-api.js" defer></script>
';
...
?>
    ...
    <div style="display:grid; grid-template-columns:repeat(2,1fr); gap:16px;">
        ...
        <!-- Backup Settings — Full Width (Municipal Scoped) -->
        <div class="card" id="mun-backupSettingsCard" style="grid-column:1/-1;">
            <div class="card-header" style="background:#f8fafc; border-bottom:1px solid #e2e8f0; padding:16px 24px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px;">
                ...
                <span style="font-size:12px; color:#64748b; background:#fef9c3; padding:4px 12px; border-radius:20px; font-weight:600; border:1px solid #fde68a;">
                    <i class="fas fa-map-marker-alt" style="color:#d97706; margin-right:4px;"></i>Municipality Backups Only
                </span>
            </div>
            <div class="card-body" style="padding:24px;">
                <!-- Municipal scope notice -->
                <div style="background:#fffbeb; border:1px solid #fde68a; border-radius:10px; padding:12px 16px; margin-bottom:20px; display:flex; align-items:center; gap:10px;">
                    <i class="fas fa-info-circle" style="color:#d97706; font-size:16px; flex-shrink:0;"></i>
                    <p style="margin:0; font-size:13px; color:#92400e; font-weight:500;">
                        Backups are scoped to your municipality only. You can only view, create, restore, or delete backups belonging to your own municipality.
                    </p>
                </div>
                <!-- Stats Row -->
                <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:12px; margin-bottom:24px;">
                    <div class="backup-stat-tile">
                        ...
                        <div class="bst-body"><div class="bst-value" id="mun-statTotalVal">–</div><div class="bst-label">Total Backups</div></div>
                    </div>
                    <div class="backup-stat-tile">
                        <div class="bst-icon" style="background:#f0fdf4;"><i class="fas fa-clock" style="color:#16a34a;"></i></div>
                        <div class="bst-body"><div class="bst-value" id="mun-statLastVal" style="font-size:12px;">–</div><div class="bst-label">Last Backup</div></div>
                    </div>
                    <div class="backup-stat-tile">
                        <div class="bst-icon" style="background:#fdf4ff;"><i class="fas fa-hdd" style="color:#9333ea;"></i></div>
                        <div class="bst-body"><div class="bst-value" id="mun-statDbSizeVal">–</div><div class="bst-label">Database Size</div></div>
                    </div>
                    <div class="backup-stat-tile">
                        <div class="bst-icon" style="background:#f0fdf4;"><i class="fas fa-check-circle" style="color:#16a34a;"></i></div>
                        <div class="bst-body"><div class="bst-value" id="mun-statStatusVal" style="color:#16a34a;">–</div><div class="bst-label">Status</div></div>
                    </div>
                </div>
                <!-- Action Buttons -->
                <div style="display:flex; gap:10px; margin-bottom:20px; flex-wrap:wrap;">
                    <button id="mun-btnCreate" class="btn-gov" onclick="window.mun_backup.create()" style="display:inline-flex; align-items:center; gap:8px; min-width:160px; justify-content:center;">
                        <i class="fas fa-download"></i> Create Backup
                    </button>
                    <button id="mun-btnRestore" class="btn-gov btn-gov-secondary" onclick="document.getElementById('mun-backupFileInput').click()" style="display:inline-flex; align-items:center; gap:8px; min-width:160px; justify-content:center;">
                        <i class="fas fa-upload"></i> Restore Backup
                    </button>
                    <input type="file" id="mun-backupFileInput" accept=".sql" style="display:none;" onchange="window.mun_backup.uploadRestore(this)">
                </div>
                <!-- Table -->
                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:10px;">
                    <h4 style="margin:0; font-size:14px; font-weight:700; color:#1e293b;">Recent Backups</h4>
                    <button onclick="window.mun_backup.loadList()" style="background:none; border:none; color:#3b82f6; font-size:12px; cursor:pointer; display:flex; align-items:center; gap:5px; font-weight:600;"><i class="fas fa-sync-alt"></i> Refresh</button>
                </div>
                ...
                <div style="margin-top:24px;">
                    ...
                    <div id="mun-backupLogsContainer" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; padding:12px 16px; font-size:13px; max-height:220px; overflow-y:auto;">
    ...
    <div class="lupto-modal-overlay" id="mun-restoreModal" style="display:none; z-index:10000;">
        <div class="lupto-modal-content" style="max-width:440px; text-align:center;">
            ...
            <div class="lupto-modal-body" style="padding:28px 24px;">
                ...
                <p style="font-size:13px; color:#64748b; margin:0;">File: <strong id="mun-restoreFileName" style="color:#1e3a8a;">–</strong></p>
            ...
            <div class="lupto-modal-footer" style="justify-content:center; gap:12px; background:#f8fafc; padding:16px; display:flex; border-top:1px solid #e2e8f0;">
                <button class="btn-gov btn-gov-secondary" onclick="window.mun_backup.closeRestoreModal()">Cancel</button>
                <button class="btn-gov" style="background:#d97706; border-color:#d97706;" onclick="window.mun_backup.confirmRestore()">
    ...
    <div class="lupto-modal-overlay" id="mun-deleteModal" style="display:none; z-index:10000;">
        <div class="lupto-modal-content" style="max-width:420px; text-align:center;">
            ...
            <div class="lupto-modal-body" style="padding:28px 24px;">
                ...
                <p style="font-size:13px; color:#64748b; margin:0;">File: <strong id="mun-deleteFileName" style="color:#dc2626;">–</strong></p>
                <p style="font-size:12px; color:#94a3b8; margin:8px 0 0;">This action cannot be undone.</p>
            </div>
            <div class="lupto-modal-footer" style="justify-content:center; gap:12px; background:#f8fafc; padding:16px; display:flex; border-top:1px solid #e2e8f0;">
                <button class="btn-gov btn-gov-secondary" onclick="window.mun_backup.closeDeleteModal()">Cancel</button>
                <button class="btn-gov" style="background:#dc2626; border-color:#dc2626;" onclick="window.mun_backup.confirmDelete()">
    ...
    <!-- Loading Overlay -->
    <div id="mun-backupLoadingOverlay" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.45); z-index:99999; align-items:center; justify-content:center; flex-direction:column; gap:16px;">
        <div style="background:#fff; border-radius:16px; padding:36px 48px; text-align:center; box-shadow:0 20px 60px rgba(0,0,0,.3);">
            ...
            <p id="mun-backupLoadingText" style="font-size:15px; font-weight:700; color:#1e293b; margin:0;">Processing...</p>
