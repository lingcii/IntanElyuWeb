...
(function () {
    ...
    function populateBarangayDropdown() {
        ...
        let name = window.municipalityData?.name || idToMunicipalityNameMap[parseInt(muniId)];
        if (name === 'San Fernando City') name = 'San Fernando';
        const barangays = barangaysByMunicipalityName[name] || [];
        barangays.forEach(b => {
