...
if (!isset($pageTitle)) {
    $pageTitle = strtoupper($userRole) . ' – Leaderboard';
}
...
<div class="lb-controls-bar">
    ...
    <button class="lb-btn-refresh" onclick="refreshLeaderboard()" title="Refresh data">
...
<!-- Shared Leaderboard JS — auto-detects role from URL path -->
<script src="../scripts/functions/leaderboard-api.js"></script>
