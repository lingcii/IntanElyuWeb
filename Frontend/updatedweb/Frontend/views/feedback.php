<?php
// Shared Tourist Feedback & Ratings view — LUPTO, PICTO, and Municipal roles.
// Displays KPI summaries, search & filters, gallery/table views, and review detail modals.

require_once __DIR__ . '/../session-bridge.php';
require_once __DIR__ . '/../laravel-api-bridge.php';
$allowedRoles = ['lupto', 'picto', 'municipal'];
require_once __DIR__ . '/_role_guard.php';
$pageTitle = strtoupper($userRole) . ' Feedback';
...
<!-- KPI Summary Cards (Reviewed Sites, Total Feedback, Rating Averages & Star Breakdown) -->
<div class="fb-kpi-grid">
    <div class="fb-kpi-card">
        <div class="fb-kpi-icon blue"><i class="fas fa-location-dot"></i></div>
        <div class="fb-kpi-info"><h4>Sites Reviewed</h4><span class="fb-kpi-value" data-fb-kpi="spots_reviewed"><i class="fas fa-spinner fa-spin" style="font-size:14px;color:#9CA3AF;"></i></span><div class="fb-kpi-label">Tourist sites with reviews</div></div>
    </div>
    <div class="fb-kpi-card">
...
<!-- Search & Filter Controls Toolbar (Municipality, Category, Rating & Date Range) -->
...
(function () {
    if (!window.__luptoFeedbackScriptInjected) {
        ...
        s.src = '../scripts/functions/feedback-api.js?v=<?= time() ?>';
