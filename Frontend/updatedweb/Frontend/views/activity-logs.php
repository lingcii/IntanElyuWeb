<?php
//   Shared Activity Logs page — LUPTO and PICTO.
...
if (!isset($pageTitle)) {
    $pageTitle = strtoupper($userRole) . ' Activity Logs';
}
...
?>
        ...
        <div class="detail-drawer-body">
            ...
            <div class="drawer-section">
                ...
                <div class="drawer-info-grid">
                    ...
                    <div class="drawer-info-item"><span class="drawer-info-label">Timestamp</span><span class="drawer-info-value" id="drawer-timestamp">-</span><span style="font-size:11px; color:var(--text-muted)" id="drawer-relative-time">-</span></div>
                    ...
                    <div class="drawer-info-item"><span class="drawer-info-label">Operating System</span><span class="drawer-info-value" id="drawer-os">-</span></div>
                    <div class="drawer-info-item full-width"><span class="drawer-info-label">User Agent</span><span class="drawer-info-value" id="drawer-user-agent" style="font-size:11px; word-break: break-all;">-</span></div>
                </div>
            </div>
    ...
    <script src="../scripts/functions/activity-logs.js?v=<?= time() ?>"></script>
<?php
