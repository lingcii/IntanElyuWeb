<?php
// Shared User Management view — LUPTO and PICTO roles.
// Manages system account creation, role assignments, status toggling, password resets, and user activity audit logging.

require_once __DIR__ . '/../session-bridge.php';
$allowedRoles = ['lupto', 'picto'];
require_once __DIR__ . '/_role_guard.php';
$pageTitle = strtoupper($userRole) . ' – User Management';
...
<div class="um-page-header">
    ...
    <div class="um-header-actions">
        ...
        <button class="btn-gov" onclick="openAddModal()">
            <i class="fas fa-user-plus"></i> <span id="btnAddUserLabel">Add User</span>
        </button>
    </div>
</div>

<!-- KPI Summary Strip (Total, Active, Inactive, Tourists & Recently Added) -->
...
<!-- Registered Users Data Table & Pagination -->
...
<!-- Set user role context and load user management API scripts -->
<script>
    window.userRole = '<?= htmlspecialchars($userRole ?? 'lupto') ?>';
</script>
<script src="../scripts/api-config.js"></script>
<script src="../scripts/functions/user-management-api.js?v=<?= time() ?>"></script>
